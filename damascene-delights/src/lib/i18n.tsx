...
const dict: Dict = {
  ...
  "about.title": { en: "Damascus, served with warmth", ar: "دمشق، نقدّمها بكل محبة" },
  "about.body": {
    en: "Our table celebrates the generous spirit of Damascene cooking: bright mezze made for sharing, shawarma carved fresh, and familiar recipes layered with spice, smoke, and care.",
    ar: "تحتفي مائدتنا بروح المطبخ الدمشقي الأصيل؛ مقبلات غنية للمشاركة، وشاورما تُحضّر طازجة، ووصفات مألوفة تمتزج فيها التوابل والنكهات المدخنة والعناية بكل تفصيل.",
  },
  "about.signature": {
    en: "Mezze to share · Shawarma carved fresh · Welcome always",
    ar: "مقبلات للمشاركة · شاورما طازجة · أهلاً وسهلاً دائماً",
  },
  ...
  "menu.calories": { en: "cal", ar: "سعرة" },
  "menu.walkingNote": {
    en: "Walking times estimate a 70 kg adult at a moderate pace.",
    ar: "أوقات المشي تقديرية لشخص بوزن 70 كجم وبسرعة متوسطة.",
  },
  "location.eyebrow": { en: "Visit us", ar: "زورونا" },
  "location.title": { en: "Find our table in Jeddah", ar: "مائدتنا بانتظاركم في جدة" },
  "location.body": {
    en: "Come for a quick shawarma or gather around the table for a full Damascene spread.",
    ar: "مرّوا لتناول شاورما سريعة أو اجتمعوا حول مائدة دمشقية متكاملة.",
  },
  "location.address": {
    en: "Prince Saud Al Faisal Street, Ar Rawdah, Jeddah",
    ar: "شارع الأمير سعود الفيصل، حي الروضة، جدة",
  },
  "location.directions": { en: "Open in Google Maps", ar: "افتح في خرائط Google" },
  "location.mapTitle": { en: "Map showing ALKHAL ALDIMASHKI in Jeddah", ar: "خريطة موقع الخال الدمشقي في جدة" },
  ...
  "footer.visit.val": { en: "Ar Rawdah, Jeddah", ar: "حي الروضة، جدة" },
