export async function onRequest(context) {
    ...
    const DASHBOARD_URL = context.env.DASHBOARD_URL || 'https://app-taqyeemi-btl-pages.pages.dev';

    return new Response(JSON.stringify({ SUPABASE_URL, SUPABASE_ANON_KEY, DASHBOARD_URL }), {
        headers: {
